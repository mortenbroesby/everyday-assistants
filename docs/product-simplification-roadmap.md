...
| 1 | Simplify product discovery and basket orchestration — medium | 0 | Keep direct rich product search, exact lookup, basket inspection, and protected review/apply operations independent. Remove planner-only orchestration and automatic authority; preserve proposal invariants and measured provider-call behavior. |
