...
<style>
body{font-family:system-ui,sans-serif;margin:0;padding:12px;color:#1a1a1a}.grid{display:grid;gap:10px}.card{border:1px solid #ddd;border-radius:10px;padding:12px;display:flex;align-items:center;justify-content:space-between;gap:12px}.product{display:flex;align-items:center;gap:12px;min-width:0}.product-image{width:72px;height:72px;object-fit:contain;border-radius:8px;background:#f7f7f7;flex:none}.name{font-weight:650}.description,.meta{color:#555;font-size:13px}.description{margin-top:3px}.badges{display:flex;gap:4px;margin-top:6px}.badge{font-size:11px;padding:2px 7px;border-radius:999px;background:#eef}.actions{text-align:right;flex:none}.price{font-weight:700;margin-bottom:6px}button{padding:8px 14px;border:0;border-radius:8px;background:#087d33;color:white;font-weight:650}.empty{color:#666;padding:16px}
</style>
</head>
