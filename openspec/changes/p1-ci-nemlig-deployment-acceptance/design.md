...
| D2 | Auth0 plan permits one scoped M2M client and token volume without new cost; accept production synthetic boundary? | Disabled and unprovisioned; blocks S3/S6 activation | Sol read-only tenant/settings/plan inventory when accessible, then concrete owner setup approval |
