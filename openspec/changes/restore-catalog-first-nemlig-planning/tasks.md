...
- [ ] 1.1 Change whole-list planning to search current catalogue inventory for every ordinary line without loading favourites, and verify focused planner tests cover multi-line candidates, ambiguity, basket gaps, and zero favourite calls.
...
- [ ] 2.1 Configure a 90-second hosted total and 85-second backend ceiling, restore 30-second Nemlig read attempts with at most one retry, and verify authentication, mutation non-retry, quotas, breaker, kill switch, one-Container ceiling, and cost bounds remain unchanged.
