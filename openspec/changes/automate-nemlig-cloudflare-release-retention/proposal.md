...
- Add a durable accepted-image ledger and deterministic retention plan; after one newly accepted baseline, reset old images in this exact production repository, then retain ten distinct accepted digests plus every active, recovery, or uncertain hold.
