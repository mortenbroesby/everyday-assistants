...
- [ ] 7.1 Run focused checks, OpenSpec strict validation, package/version planning, privacy/safety verification, and final `pnpm verify`; record that implementation made no credential, provider, or basket mutation.
