...
- [x] 5.1 Run focused picker, interface, MCP safety, accessibility, offline, package, performance-observation, privacy, OpenSpec, and final `pnpm verify` checks; record that no credentials, provider calls, basket mutations, or deployment mutations occurred.
