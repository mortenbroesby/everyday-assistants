...
- [ ] 4.3 Review the final diff for unchanged safety/cost controls, update and push the scoped pull request, and verify the remote head and exact-head CI; do not merge or deploy without the separately applicable protected workflow decision.
