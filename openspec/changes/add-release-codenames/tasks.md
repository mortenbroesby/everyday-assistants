...
- [x] 4.3 Review the final diff for unchanged safety/cost controls, commit and push the scoped branch, open one pull request, and verify the remote head and exact-head CI; do not merge or deploy without the separately applicable protected workflow decision.
