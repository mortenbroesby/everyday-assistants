...
- [ ] 4.1 Run the release planner with reviewed codename `Callsign`, apply final plain version `4.8.0`, replace the superseded alpha-version note with the matching bounded note, and verify the exact candidate passes version and note gates without tagging, publishing, or deploying.
